...
namespace SiteAsientos.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            var existingEmployee = _context.Employee.Where(x => x.Employee_Email == employee.Employee_Email);
        ...
        {
            var existingEmployee = _context.Employee.Where(x => x.Employee_Phone == employee.Employee_Phone);
            if (existingEmployee.Any())
            {
                return Json(false);
            }
