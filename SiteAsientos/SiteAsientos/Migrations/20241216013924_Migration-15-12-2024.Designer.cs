...
namespace SiteAsientos.Migrations
{
    ...
    [Migration("20241216013924_Migration-15-12-2024")]
    partial class Migration15122024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SiteAsientos.Models.Image", b =>
                {
                    ...
                    b.Property<int>("Image_ImageId")
                        .HasColumnType("int");

                    b.HasKey("Image_Id");

                    b.HasIndex("Image_ImageId");
            ...
            modelBuilder.Entity("SiteAsientos.Models.Order", b =>
                {
                    ...
                    b.Property<int?>("Order_SupplierId")
                        .HasColumnType("int");
